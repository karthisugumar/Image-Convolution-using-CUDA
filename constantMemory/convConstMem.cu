...
#include <//home/ksugmar/ImageConvolutionUsingCUDA/headers/helper_functions.h>
#include <//home/ksugmar/ImageConvolutionUsingCUDA/headers/helper_cuda.h>
#include "device_launch_parameters.h"
#include <chrono>

#define STB_IMAGE_IMPLEMENTATION
#define STB_IMAGE_WRITE_IMPLEMENTATION
#include "//home/ksugmar/ImageConvolutionUsingCUDA/headers/stb_image.h"
#include "//home/ksugmar/ImageConvolutionUsingCUDA/headers/stb_image_write.h"
...
__global__ void imageFilteringkernel\
	(const float *d_image_pad, const unsigned int r_pad, const unsigned int c_pad,
	...
	if (j > padding_size && j < c_pad - padding_size && i > padding_size && i < r_pad - padding_size)
	{
		...
		for (int k = -padding_size; k <= padding_size; k++)
		{
			for (int l = -padding_size; l <= padding_size; l++)
			{
				...
				d_conv_image[conv_pixel_pos] += d_image_pad[img_pixel_pos] * d_cFilterKernel[filter_pos];
			}
		}
	}
}
...
// **** CONVOLUTION STARTS HERE ! ****
	...
	imageFilteringkernel <<<grid, threadBlock>>>(d_padded_image, r_pad, c_pad, padding_size, d_conv_image, rows, cols);
	checkCudaErrors(cudaDeviceSynchronize());
