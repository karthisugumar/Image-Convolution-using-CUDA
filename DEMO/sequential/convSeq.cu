...
#include <//home/ksugumar/ImageConvolutionUsingCUDA/DEMO/headers/helper_functions.h>
#include <//home/ksugumar/ImageConvolutionUsingCUDA/DEMO/headers/helper_cuda.h>
...
#include "//home/ksugumar/ImageConvolutionUsingCUDA/DEMO/headers/stb_image.h"
#include "//home/ksugumar/ImageConvolutionUsingCUDA/DEMO/headers/stb_image_write.h"
...
// ***** CONVOLUTION STARTS HERE ! *****
	...
	for (int i = padding_size; i < r_pad - padding_size; i++) {
		for (int j = padding_size; j < c_pad - padding_size; j++) {
			...
			//	cout << conv_image_1d[oPixelPos] << " ";
			conv_count += 1;
			//	cout << "Conv count is " << conv_count << "\n ";
		}
	}
